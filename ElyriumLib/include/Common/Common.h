...
#endif
template <class Msg> inline constexpr void elyriumAssert(bool, Msg);
template <class Msg> inline constexpr void vulkanAssert(int, Msg);
template <class Format, typename ... Args> inline constexpr void elyriumAssert(bool, Format&&, Args&&...);
...
#ifndef NDEBUG
#define ASSERT(...) elyrium::elyriumAssert(__VA_ARGS__)
#define VULKAN_ASSERT(...) elyrium::vulkanAssert(__VA_ARGS__)
#else
