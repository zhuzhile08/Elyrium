...
template <class Msg> inline constexpr void elyriumAssert(bool condition, Msg message) {
	if (!condition) {
...
template <class Format, typename ... Args> inline constexpr void elyriumAssert(bool condition, Format&& format, Args&&... message) {
	if (!condition) {
